        ...
        <div class="own-container content-grid">
            <form action="{{ route('contact.sendToEmail') }}" method="POST" class="bg-white p-8 rounded-lg shadow-md space-y-5 w-full max-w-2xl mx-auto">
                ...
                <div>
                    ...
                    <input type="text" id="name" name="name" class="w-full border border-gray-300 rounded-md p-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Unesite ime" required/>
                </div>
                <div>
                    <label for="surname" class="block text-gray-700 font-medium text-base mb-2">Prezime *</label>
                    <input type="text" id="surname" name="surname" class="w-full border border-gray-300 rounded-md p-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Unesite prezime" required/>
                </div>
                <div>
                    <label for="email" class="block text-gray-700 font-medium text-base mb-2">Email *</label>
                    <input type="email" id="email" name="email" class="w-full border border-gray-300 rounded-md p-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Unesite email adresu" required email/>
                ...
                <div>
                    ...
                    <input type="date" id="date" name="date" class="w-full border border-gray-300 rounded-md p-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" required/>
                    <span class="block text-sm text-gray-500 mt-1">
                ...
                <div>
                    ...
                    <textarea id="note" name="note" class="w-full border border-gray-300 rounded-md p-3 text-base focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Dodajte napomenu ili pitanje" rows="4"></textarea>
                </div>
                <div>
