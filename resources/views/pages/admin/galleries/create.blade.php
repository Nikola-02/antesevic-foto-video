...
@section('content')
    <h2 class="text-2xl fw-bolder text-center mt-8 mb-5">Napravi novu galeriju</h2>

    <form class="max-w-sm mx-auto mb-12" action="/admin/galleries" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-4">
...
{{--            <p class="mt-1 ml-1">Galeriju upiši u množini</p>--}}
        ...
        <div class="mb-4">
            <label for="categories" class="block mb-2 text-sm font-medium text-gray-900">Izaberi kategoriju</label>
