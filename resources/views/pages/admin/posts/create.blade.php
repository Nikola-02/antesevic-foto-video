...
@section('content')
    <h3 class="text-2xl fw-bolder text-center text-blue-500 ml-3 mb-4"><span class="text-dark ">Galerija: </span> {{ strtoupper($gallery->name)  }}</h3>
    <h2 class="text-2xl fw-bolder text-center mt-8 mb-3">Novi post</h2>

    <form class="max-w-sm mx-auto mb-12" action="/admin/posts" method="post" enctype="multipart/form-data">
        @csrf
        <div class="mb-4">
            ...
            {{--            <p class="mt-1 ml-1">Galeriju upiši u množini</p>--}}
            @error('name')
